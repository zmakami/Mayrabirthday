...
const reasons = [
  "Por tus cejas.",
  "Porque me llevas a comer cosas muy ricas.",
  "Porque me presumes y eso se siente bello.",
  "Porque hueles rico.",
  "Porque tienes a kekita.",
  "Porque eres una super buena viajera.",
  "Porque me amas.",
  "Porque quieres trabajar en nosotros.",
  "Porque tu corazon es bello.",
  "Porque estas dispuesta a aprender cosas nuevas por amor.",
  "Porque tu perri favorita es Kimi.",
  "Porque tu sentido de la moda hace que yo reevalúe cosas que cinco minutos antes juraba que se veían bien.",
  "Porque me contrataste como tu quiro particular.",
  ...
  "Porque te gusta el pollito koreano jaja.",
  "Porque tienes ese balance raro entre tierna y malvada.",
  "Por tu humor escondido que es bastante obscuro.",
  "Porque eres competitiva incluso cuando nadie anunció que era competencia.",
  "Porque me amas otra vez.",
  "Porque esta bueno el chismesito.",
  "Porque me haces querer planear cosas ridículamente específicas solo para verte emocionada.",
  "Porque me traes matchitas.",
  ...
  "Porque me das mas que tu tiempo.",
  "Porque eres la razón por la que “nomás un viaje” terminó siendo una experiencia con countdown.",
